...
| [azurerm_virtual_machine_scale_set_extension.ado_pool](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/virtual_machine_scale_set_extension) | resource |
...
| <a name="input_ado_project"></a> [ado\_project](#input\_ado\_project) | Azure DevOps project name | `string` | n/a | yes |
...
| <a name="input_ado_shell_script_enabled"></a> [ado\_shell\_script\_enabled](#input\_ado\_shell\_script\_enabled) | Whether to use the shell\_script provider as part of the module | `bool` | `true` | no |
...
| <a name="input_vmss_enabled"></a> [vmss\_enabled](#input\_vmss\_enabled) | Whether to process the Linux Virtual Machine Scale Set resource | `bool` | `true` | no |
...
| <a name="input_vmss_resource_group_name"></a> [vmss\_resource\_group\_name](#input\_vmss\_resource\_group\_name) | Existing resource group name of where the VMSS will be created (data source) | `string` | n/a | yes |
...
| <a name="input_vmss_subnet_name"></a> [vmss\_subnet\_name](#input\_vmss\_subnet\_name) | Existing subnet name of where the VMSS will be connected (data source) | `string` | n/a | yes |
| <a name="input_vmss_vnet_name"></a> [vmss\_vnet\_name](#input\_vmss\_vnet\_name) | Existing Vnet name where the subnet is located (data source) | `string` | n/a | yes |
| <a name="input_vmss_vnet_resource_group_name"></a> [vmss\_vnet\_resource\_group\_name](#input\_vmss\_vnet\_resource\_group\_name) | Existing resource group where the Vnet containing the subnet is located (data source) | `string` | n/a | yes |
